...
const COLORS = ["#d4af37", "#3a86ff", "#06d6a0", "#ffb703"];
    ...
    <div className="page-section">
      ...
      <div className="pg-header">
        <div>
          ...
          <p className="pg-sub">Real-time stats and analytics for Nasha OTT</p>
        </div>
        ...
        <div className="content-box">
          ...
          <ResponsiveContainer width="100%" height={260}>
            <AreaChart data={GROWTH} margin={{ top: 8, right: 12, left: -18, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="users" stroke="#d4af37" strokeWidth={2.5}
                fill="url(#goldGrad)"
                activeDot={{ r: 6, fill: "#d4af37", stroke: "var(--bg2)", strokeWidth: 3 }} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
